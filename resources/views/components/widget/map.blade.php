    ...
    <div class="container">
        <div class="col-12">
            <div class="mapt-title-container">
                <h6 class="text-secondary text-uppercase wow fadeInRight" data-wow-delay="0.1s">{{ $title ?? 'Ports Coverage' }}</h6>
                <h2 class="text-primary text-uppercase wow fadeInRight" data-wow-delay="0.1s">Global Ports Network</h2>
                <p class="wow fadeIn" data-wow-delay="0.1s">Through our trusted partners, we provide ship agency services in major ports worldwide.</p>
            </div>
        </div>
    </div>
</x-widget.container>
